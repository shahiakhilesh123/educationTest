              ...
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="batch_name" value="{{ $data->batch_name }}" class="form-control" id="batch_name">
                    @error('batch_name')
                    ...
                    <div class="select2-purple">
                        <select class="form-control" name="batch_mode">
                            ...
                            @foreach($modes as $mode)
                              <option value="{{ $mode->id }}" <?php if($data->batch_mode == $mode->id) { echo "selected"; } ?>>{{ $mode->mode_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('batch_mode')
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="start_date" value="{{ $data->start_date }}" class="form-control" id="start_date">
                    @error('start_date')
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <!-- <span class="fas fa-envelope"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="phone_number" value="{{ $data->phone_number }}" class="form-control" id="phone_number">
                    @error('phone_number')
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <!-- <span class="fas fa-envelope"> -->
                    ...
                    <div class="select2-purple">
                        <select class="form-control" name="medium">
                            ...
                            @foreach($mediums as $medium)
                              <option value="{{ $medium->id }}" <?php if($data->medium == $medium->id) { echo "selected"; } ?>>{{ $medium->language_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('medium')
