      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{asset('study/material/add')}}" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="about_study" class="form-control summernote" id="about_study"></textarea>
                    @error('about_study')
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <!-- <span class="fas fa-envelope"> -->
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="study_material_mantra" class="form-control summernote" id="study_material_mantra"></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="online_old_price" class="form-control" id="online_old_price">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="offline_price" class="form-control" id="offline_price">
                    @error('offline_price')
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <!-- <span class="fas fa-envelope"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="offline_old_price" class="form-control" id="offline_old_price">
