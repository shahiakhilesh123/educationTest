                ...
                <div class="card-tool s">
                  <div class="input-group input-group-sm float-right" style="width: 150px;">
                    ...
                    <!-- <div class="input-group-append"> -->
                      ...
                      <a href="{{ asset('/syllabus') }}/add" class="btn btn-primary ">
                        Add Syllabus
                      </a>  
                      <?php } ?>
                    <!-- </div> -->
                    ...
                    @foreach($all as $data)
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ asset('syllabus') }}/edit/{{$data->id}}"><i class="fas fa-edit"></i></a>
                          <?php } ?>
                          <a href="{{ asset('syllabus') }}/view/{{$data->id}}"><i class="fa fa-eye"></i></a>
                        </td>
                      </tr>
                    @endforeach
                  @else
