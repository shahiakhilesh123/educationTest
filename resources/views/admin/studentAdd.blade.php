      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{asset('student/add')}}" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" value="{{ old('aadhar_id') }}" id="aadhar_id" name="aadhar_id">
                    @error('aadhar_id')
                        <div class="input-group-append">
                          <div class="input-group-text">
                            <!-- <span class="fas fa-envelope"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" value="{{ old('marksheet') }}" id="marksheet" name="marksheet">
                    @error('marksheet')
                        <div class="input-group-append">
                          <div class="input-group-text">
                            <!-- <span class="fas fa-envelope"> -->
